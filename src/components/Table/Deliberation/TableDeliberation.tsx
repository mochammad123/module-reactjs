  ...
  return (
    <>
      <Table
        ...
        sizeTable={menus?.data?.role?.name == "admin" ? 350 : 400}
        doubleClick={(params: any) => {
          setDataDoubleClick(params?.data);
          setShow(true);
        }}
        onSortChanged={
          dataDeliberationPagination?.perPage == 0 ? null : onSortChanged
        }
      />
    </>
  );
...
export default TableDeliberation;
